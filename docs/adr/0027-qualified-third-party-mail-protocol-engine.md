...
actual pre- and post-content SMTP task cancellation, sender/recipient/`DATA` rejection, accepted responses without message IDs, exact multi-recipient SMTP and Sent-append payloads,
