...
supersedes the provider-bypass prohibition for the replacement client's isolated
Mock Mail Sessions. External test ownership and exclusion of production backdoors
remain requirements. The existing client's test path continues to follow the
contract below until it is replaced.
