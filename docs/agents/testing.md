...
failure. [The Apple validation guide](apple-validation.md) defines the complete ownership and cleanup contract.
...
## Historical portfolio rollout

The original test-portfolio rollout was sequenced as follows:
