...
Status: local and cross-device Send Reminder and originating-device Gmail Scheduled Send implemented; cross-device delivery claims, provider parity, and full Outbox management remain planned
