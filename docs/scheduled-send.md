...
Status: cross-device Send Reminder plus Gmail, Microsoft Graph, On-Premises Exchange, and Standards-Based Scheduled Send delivery, revision-fenced Outbox management, lifecycle hardening, deterministic local evidence, and protected provider compatibility evidence implemented; Scheduled Send is enabled for release
