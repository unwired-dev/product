...
5. Mark a Standards-Based Mailbox Connection delivery durably sent only after SMTP acceptance and a confirmed append to its mapped Sent role. Keep ambiguous attempts immutable and require explicit user resolution instead of automatic retry.
