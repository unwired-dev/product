...
- Send Reminder interruption is governed by the existing default-on **Return to Attention** preference together with device Quiet, Profile Quiet, Profile Lock, OS notification authorization, and device-local lock-screen content policy
